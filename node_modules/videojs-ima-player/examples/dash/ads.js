...
function playStream(url, tag){
	...
	player.ima.updateOptions({adTagUrl: tag});

	player.on('adsready', () => console.log('adsready'))
	player.on('readyforpreroll', () => console.log('readyforpreroll'))
	player.on(['contentupdate'], () => console.log('loadstart'))
	player.src(source);
}
